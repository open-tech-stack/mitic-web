...
import { Calendar, Plus, BarChart2, DollarSign, Users, List, CheckCircle, XCircle, Info, Clock } from "lucide-react";
...
export default function AbonnementPage() {
  ...
  const loadAbonnes = async () => {
    try {
      const abonnesData = await abonneService.loadAll();
  ...
  const totalAmount = abonnements.reduce((sum, a) => sum + (a.tarifAbonnement?.montant || 0), 0);
        ...
        <div className="header-content flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-purple-600/70 dark:text-purple-400/70 mt-2">
              Gérez les abonnements des utilisateurs avec leurs péages et tarifs.
            </p>
          </div>
      ...
      <PermissionGuard permission="READ_ABONNEMENT">
        <div className="stats-section grid grid-cols-1 md:grid-cols-4 gap-4 mt-6 mb-8">
          ...
          <div className="stat-card bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/30 dark:to-purple-800/20 rounded-2xl p-6 backdrop-blur-sm border border-purple-200/30 dark:border-purple-700/30">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-purple-600/70 dark:text-purple-400/70 text-sm">Abonnements Actifs</p>
                <p className="text-2xl font-bold text-purple-900 dark:text-purple-100">{stats.active}</p>
              </div>
              <div className="p-3 rounded-xl bg-purple-200/30 dark:bg-purple-700/30">
                <CheckCircle className="w-6 h-6 text-purple-700 dark:text-purple-300" />
              </div>
            </div>
          </div>
          ...
          <div className="stat-card bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/30 dark:to-purple-800/20 rounded-2xl p-6 backdrop-blur-sm border border-purple-200/30 dark:border-purple-700/30">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-purple-600/70 dark:text-purple-400/70 text-sm">Abonnements Inactifs</p>
                <p className="text-2xl font-bold text-purple-900 dark:text-purple-100">{stats.inactive}</p>
              </div>
              <div className="p-3 rounded-xl bg-purple-200/30 dark:bg-purple-700/30">
                <XCircle className="w-6 h-6 text-purple-700 dark:text-purple-300" />
              </div>
            </div>
          </div>
          ...
          <div className="stat-card bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/30 dark:to-purple-800/20 rounded-2xl p-6 backdrop-blur-sm border border-purple-200/30 dark:border-purple-700/30">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-purple-600/70 dark:text-purple-400/70 text-sm">Montant Total</p>
